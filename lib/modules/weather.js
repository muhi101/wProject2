...
*/
define(['underscore','jquery','jquery.bootstrap', 'async!http://maps.googleapis.com/maps/api/js?libraries=places&sensor=false'], function(underscore,jquery,placemaker) {
